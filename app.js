setTimeout(() => {
    ...
    post.addEventListener("click", async () => {
        ...
        try {
            // FIXED: Pointing to your specific Render URL and /chat path
            ...
            function CreateMessage(text, color, type) {
                ...
                // Keeping your original dynamic sizing logic
            ...
            // FIXED: Correct access to data.choices[0] for the response
            if (data.choices && data.choices[0]) {
                setTimeout(() => {
                    var responceresult = data.choices[0].message.content
                    CreateMessage(responceresult, "blue", 0) // type 0 for bot
