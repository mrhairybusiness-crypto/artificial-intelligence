        ...
        try {
            const response = await fetch("https://aibackend-3srf.onrender.com", {
                ...
                body: JSON.stringify({
                    ...
                    messages: [{ role: "user", content: userInput + "|" + content + "|" + "**CODE GUIDELINES** at the START OF YOUR CODE THERE SHOULD BE :CODE AT THE START FOLLOWED WITH A SPACE AND AT THE END A SPACE AND THEN :CODE IS AT THE END OF YOUR CODE OR YOU FAILED BEING A AI"}]
                })
            });
